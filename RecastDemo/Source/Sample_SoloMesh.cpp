...
void Sample_SoloMesh::handleRender()
{
         ...
         m_drawMode == DRAWMODE_NAVMESH_INVIS))
    {
        ...
        duDebugDrawNavMeshPolysWithFlags(&m_dd, *m_navMesh, SAMPLE_POLYFLAGS_DISABLED, duRGBA(255, 0, 0, 128));
    }
...
bool Sample_SoloMesh::handleBuild()
{
    ...
    if (m_cfg.maxVertsPerPoly <= DT_VERTS_PER_POLYGON)
    {
        ...
        for (int i = 0; i < m_pmesh->npolys; ++i)
        {
            ...
            if (m_pmesh->areas[i] == SAMPLE_POLYAREA_GROUND || m_pmesh->areas[i] == SAMPLE_POLYAREA_GRASS ||
